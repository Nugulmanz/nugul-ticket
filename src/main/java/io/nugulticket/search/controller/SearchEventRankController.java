...
public class SearchEventRankController {
    ...
    @PostMapping("/events")
    public ApiResponse<Map<String, Object>> addEvent(@RequestParam String eventTitle) {
        Map<String, Object> response = searchEventRankService.addKeywordAndGetScore(eventTitle);
